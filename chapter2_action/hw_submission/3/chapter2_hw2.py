...
if __name__ == "__main__":
    ...
    # lunarlander_continuous()  # done
    # rocket_landing()
    # drone_fly()
    hybrid_moving()

    # pip install requests -i https://mirrors.aliyun.com/pypi/simple/ git+https://github.com/nighood/rocket-recycling@master#egg=rocket_recycling
