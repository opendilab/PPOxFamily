...
little_RND_net_config = dict(
    exp_name="output/ch4/little_rnd_network",
...
small_RND_net_config = dict(
    exp_name="output/ch4/small_rnd_network",
    observation_shape=2835,
...
standard_RND_net_config = dict(
    exp_name="output/ch4/standard_rnd_network",
    observation_shape=2835,
...
large_RND_net_config = dict(
    exp_name="output/ch4/large_RND_network",
    observation_shape=2835,
...
very_large_RND_net_config = dict(
    exp_name="output/ch4/very_large_RND_network",
    observation_shape=2835,
...
class RndRewardModel():
    ...
    def __init__(self, config) -> None:  # noqa
        ...
        self.tb_logger = SummaryWriter(os.path.join('output/ch4', config["exp_name"]))
...
def training(config, train_data, test_data):
    ...
    for i in tqdm(range(train_config["train_iter"])):
