...
<link https://arxiv.org/pdf/1506.02438.pdf link>
"""
...
def gae(data: tuple, gamma: float = 0.99, lambda_: float = 0.97) -> torch.FloatTensor:
    ...
    **Overview**:
    ...
    Arguments:
        - data (:obj:`namedtuple`): gae input data which contains some episodes or trajectories data.
        - gamma (:obj:`float`): the future discount factor, should be in [0, 1], defaults to 0.99.
        - lambda (:obj:`float`): the gae parameter lambda, should be in [0, 1], defaults to 0.97,
...
def test_gae() -> None:
    """
    **Overview**:
        Test gae function with random generated data.
    """
