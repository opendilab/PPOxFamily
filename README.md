...
| [第三章：表征多模态动作空间](https://www.bilibili.com/video/BV1rK411r7Kg) | [课程PPT](https://github.com/opendilab/PPOxFamily/blob/main/chapter3_obs/chapter3_lecture.py) | PPG <br> 表征学习+RL | 习题（1.18更新） | Tensor 操作示例<br> Env Wrapper 示例<br>计算图示例<br>应用训练代码 | [软体机器人等](https://github.com/opendilab/PPOxFamily/issues/8) |
