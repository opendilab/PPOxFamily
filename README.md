...
- 2022.12.23: PPO x Family 第二章（解构复杂动作空间）正式上线（视频将尽快更新）
...
| 第二章：解构复杂动作空间 <br> | [课程PPT](https://github.com/opendilab/PPOxFamily/blob/main/chapter2_action/chapter2_lecture.pdf) | [PPO&DDPG](https://github.com/opendilab/PPOxFamily/blob/main/chapter2_action/chapter2_supp_ppovsddpg.pdf) <br> [HyAR](https://github.com/opendilab/PPOxFamily/blob/main/chapter2_action/chapter2_supp_hyar.pdf) | 12.28更新 | [离散动作示例](https://github.com/opendilab/PPOxFamily/blob/main/chapter2_action/discrete_tutorial_zh.py) <br> [连续动作示例](https://github.com/opendilab/PPOxFamily/blob/main/chapter2_action/continuous_tutorial_zh.py) <br> [混合动作示例](https://github.com/opendilab/PPOxFamily/blob/main/chapter2_action/hybrid_tutorial_zh.py) <br> 12.28更新应用训练代码 | [火箭回收等](https://github.com/opendilab/PPOxFamily/issues/4) |
| 第三章：表征多模态动作空间 <br>（一月上旬）| | | | | |
